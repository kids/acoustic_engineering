...
if __name__ == '__main__':
    ...
    ndf.show(10,False)
    #ndf.write.mode('Append').insertInto('wecar.t_si_wecar_voicedata_log_fmt')
    # ndf.write.save('mdfs://cloudhdfs/wecar/hive/wecar.db/t_si_wecar_voicedata_log_fmt/ds={}'.format(ds),
    #          format='parquet', mode='overwrite')
    ndf.write.save('hdfs://10.49.136.154:9000/user/wecar/audio/voicedata_log_fmt/ds={}'.format(ds),
             format='parquet', mode='overwrite')
